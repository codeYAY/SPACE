...
const cards = [
    {
        ...
        description:
            "Turn your ideas into fully functional web apps instantly using AI. Build interactive applications, dashboards, and tools without writing a single line of code. Perfect for rapid prototyping and bringing concepts to life.",
        color:
        ...
        svg: (
            <svg
                ...
                className="absolute right-[-10%] bottom-[-4%] max-h-[40%] max-w-[80%] rotate-[-20deg] transition-all duration-[400ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:translate-x-[-5%] group-hover:translate-y-[-5%]"
            >
                ...
                <path d="M22.5164 146.35H51.4649V160.825H65.9391V175.299H80.4133V14.4741H109.362V146.35H123.836V86.8452H152.784V160.825H167.259V101.319H196.207V175.299H210.681V115.794H225.156V130.268H239.63V218.721H225.156V260.536H210.681V291.093H94.8875V276.618H80.4133V247.67H65.9391V218.721H51.4649V189.773H36.9906V160.825H22.5164V146.35Z" fill="#E2FC91" stroke="black" strokeWidth="8" />
            </svg>
        ),
    },
    {
        ...
        description:
            "Your code runs safely in an isolated environment, protecting your data. Execute JavaScript, Python, and other languages without security risks. All operations are containerized and sandboxed for maximum safety.",
        color:
        ...
        svg: (
            ...
            >
                ...
                <path d="M60 45V30H90V15H105V30H135V45H150V60H165V90H180V105H165V135H150V150H135V165H120V194H75V165H60V150H45V135H30V105H15V90H30V60H45V45H60Z" fill="#E2FC91" stroke="black" strokeWidth="8" />
    ...
    },
    {
        ...
        description:
            "Fully open source, self-host with private keys for maximum control. Deploy on your own infrastructure, customize to your needs, and maintain complete ownership of your data and applications. No vendor lock-in.",
        color:
        ...
        svg: (
            ...
            >
                ...
                <path d="M125.85 45V30H155.85V15H170.85V30H200.85V45H215.85V60H230.85V90H245.85V105H230.85V135H215.85V150H200.85V165H170.85V180H155.85V165H125.85V150H110.85V135H95.8499V105H80.8499V90H95.8499V60H110.85V45H125.85Z" fill="#E2FC91" stroke="black" strokeWidth="8" />
    ...
    return (
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6 [perspective:1200px]">
            {cards.map((card, i) => (
                <details
                    key={i}
                    className={`[pointer-events:none] relative w-full transition-all duration-[1000ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] [transform-style:preserve-3d] group ${card.rotation} hover:rotate-0 open:[transform:rotateY(180deg)]`}
                >
                    <summary
                        className={`[pointer-events:all] relative aspect-[3/4] border-[5px] border-black dark:border-white rounded-2xl p-[5%] ${card.color} cursor-pointer overflow-clip [backface-visibility:visible] list-none [transform:translateZ(2px)]`}
                    >
                        <h1 className="text-[clamp(2rem,6vw,3rem)] font-bold mb-4 leading-none">
                            {card.title}
                        </h1>
                        {card.svg}
                    </summary>

                    <div className="[pointer-events:none] absolute top-0 left-0 w-full h-full aspect-[3/4] border-[5px] border-black dark:border-white rounded-2xl p-[5%] bg-white dark:bg-gray-900 [transform:rotateY(180deg)_translateZ(-1px)] [backface-visibility:visible] flex items-center justify-center text-center">
                        <p className="text-[clamp(1rem,2vw,1.25rem)] leading-snug max-w-[90%] text-gray-900 dark:text-gray-100">
                            {card.description}
                        </p>
                    </div>
                </details>
